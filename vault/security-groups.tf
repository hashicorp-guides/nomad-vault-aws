resource "aws_security_group" "hashistack_server" {
  ...
  tags {
    Name    = "HashiStack Server (${random_id.environment_name.hex})"
    Cluster = "${replace(random_id.environment_name.hex, " ", "")}"
  }
...
resource "aws_security_group" "consul_client" {
  ...
  tags {
    Name          = "Consul Client (${random_id.environment_name.hex})"
    ConsulCluster = "${replace(random_id.environment_name.hex, " ", "")}"
  }
